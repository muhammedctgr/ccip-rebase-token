...
contract RebaseTokenTest is Test {
    ...
    function testDepositLinear(uint256 amount) public {
        ...
        // 4. warp more time and check the balance again
        vm.warp(block.timestamp + 1 hours);
    ...
    function testTransfer(uint256 amount, uint256 amountToSend) public {
        ...
        // Owner reduces interest rate for testing
        vm.prank(owner);
        rebaseToken.setInterestRate(4e10); // 4% annual
        ...
        // Check if the user interest has been inherited (5e10 not 4e10)
